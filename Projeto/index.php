...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/cssdoindex.css">
...
<body>
	...
	<!-- cole e cold são as colunas do site -->
	<div id="cole">
	</div>
	<div id="meio">
		...
		<div id="cabeçalho">
			<ul>
				<li><a href="home"><strong>Criadores</strong></a></li>
				<li><a href="criadores"><strong>Home</strong></a></li>
				<li><button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">
		<strong>Restrições</strong> </button></li>
...
#c
					...
					<img src="imagens/if help.png" alt="Logo" style=" width: 20%;">
	...
	<script src="js/bootstrap.min.js"></script>
				...
				<li id="Entrar"><a href="login"><strong>Entrar</strong></a></li>
			</ul>
		</div>
		...
		<div id="meio2">
			...
			<div id="botao">
				<h3 id="h3"><a href="forum">Acesse o nosso fórum</a></h3>
			</div>
		</div>
