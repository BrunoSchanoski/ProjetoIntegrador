...
<head>
  ...
  #cont1{
    margin-top:-1.5%;
    background:url("imagem/back2.jpg");
...
<body>
  ...
  <main class="main-container">
    <div id="cont1">	
     <div class="container-fluid">
      <div class="container">
       <center><img src="imagem/logo.png" style="margin-bottom:2%;"></center>
       <div class="row" style="background-color:#FBF9FB; opacity:0.3;border-radius:200px;">

        <div class="col-md-4">
        </div>
        <div class="col-md-4">
          <br>
          <p class="blackp">Este site tem como objetivo principal oferecer suporte às vitimas da depressão. Tanto por experiência própria, como por pesquisa. Temos a noção da grandeza deste problema e, perante o mesmo, decidimos criar uma plataforma online para um chat de atendimento, tendo como fundamento a interação entre usuário e paciente (usuário).
            Baixe nossa pesquisa para saber mais.
    ...
    <div class="container-fluid">
      <div class="container">
       <div class="row">
        ...
        <div class="col-lg-4 ">
         <center><button type="button" class="btn btn-success">Acesse nosso forum!</button><br><br>
           <button type="button" class="btn btn-danger">Restrições</button></center>
         </div>
       </div>
     </div>
   </div>
 ...
 <div id="cont2">
  <div class="container">
    ...
    <center><iframe style="border:none" width="360" height="206"
      src="video.mp4">
    </iframe>
    <h4>Gostou? Assita mais <a href="https://www.youtube.com/user/MOVAFILMES">aqui</a></h4></center>
  </body>
  </html>
  <div>
  </div>
